if __name__ == "__main__":
    ...
    folder = "4x4,Rb=1.20,Δ=1.10,β=10.000_data"
    ...
    dataloader = DataLoader(os.path.join(basefolder, folder, 'data.jld'))
    ...
    # )
    energy, standard_deviation, loss = train_vmc(model, h, nsamples=100, iterations=20_000,lr=0.0001)
